...
- **Catálogo de plantas** — fichas curadas (55 culturas) com valores agronómicos reais para o clima atlântico: quando semear, germinação, profundidade, espaçamento, pH, sol, rega, pragas/doenças, consociação, segurança/toxicidade e benefícios para a saúde. Pesquisa com tolerância a acentos e filtros.
