...
export const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/catalogo',
      name: 'catalog',
      component: () => import('@/features/catalog/CatalogView.vue'),
      meta: { title: 'Catálogo de plantas' },
    },
    {
      path: '/planta/:slug',
      name: 'plant',
    ...
    },
    {
      path: '/jardim',
      name: 'garden',
      component: () => import('@/features/garden/GardenView.vue'),
      meta: { title: 'A minha horta' },
    },
    {
      path: '/jardim/plano',
      name: 'planner',
      component: () => import('@/features/planner/PlannerView.vue'),
      meta: { title: 'Plano da horta' },
    },
    {
    ...
    },
    {
      path: '/curso',
      name: 'course',
      component: () => import('@/features/course/CourseView.vue'),
      meta: { title: 'Curso' },
    },
    {
      path: '/curso/revisao',
    ...
    },
    {
      path: '/saude',
      name: 'health',
      component: () => import('@/features/health/HealthView.vue'),
    ...
    },
    {
      path: '/glossario',
      name: 'glossary',
      component: () => import('@/features/glossary/GlossaryView.vue'),
      meta: { title: 'Glossário' },
    },
    {
      path: '/legal',
      name: 'legal',
      component: () => import('@/features/legal/LegalView.vue'),
      meta: { title: 'Privacidade e termos' },
    },
