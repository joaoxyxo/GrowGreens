...
export const PESTS: Pest[] = [
  {
    ...
    name: 'Afídeo (pulgão)',
    emoji: '🐛',
    description: 'Pequenos insetos (verdes, pretos ou rosados) que se agrupam nos rebentos tenros e por baixo das folhas. Surgem sobretudo na primavera, quando há muita rebentação nova.',
  ...
  },
  {
    ...
    emoji: '⚫',
    description: 'Minúsculos besouros saltadores que atacam brássicas jovens, sobretudo rúcula e rabanete. Mais ativa na primavera e no verão quente e seco.',
  ...
  },
  {
    ...
    name: 'Mosca-branca',
    emoji: '⚪',
    description: 'Insetos brancos minúsculos que voam em nuvem quando se mexe a planta; comuns em tomate e pimento. Pico no fim do verão e o ano todo em estufa ou interior.',
